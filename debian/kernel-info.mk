...
KERNEL_BOOTIMAGE_CMDLINE = "androidboot.hardware=qcom androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 androidboot.usbcontroller=a600000.dwc3 swiotlb=2048 loop.max_part=7 cgroup.memory=nokmem,nosocket firmware_class.path=/vendor/firmware_mnt/image printk.devkmsg=on pcie_ports=compat cpuinfo.chipname=SM8350 panic=4"
...
DEVICE_FULL_NAME = Samsung Z Fold 3 5G
...
KERNEL_CONFIG_EXTRA_FRAGMENTS = common_fragments/debug.config common_fragments/droidian.config common_fragments/halium.config
...
# Defconfig to use
KERNEL_DEFCONFIG = vendor/q2q_eur_openx_defconfig
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/samsung/q2/q2q/q2q_eur_openx_w00_r08.dtbo
...
KERNEL_BOOTIMAGE_PATCH_LEVEL = 2023-05-05
...
DEB_TOOLCHAIN = linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross, clang-android-10.0-r370808
